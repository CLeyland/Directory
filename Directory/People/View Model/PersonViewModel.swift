...
class PersonViewModel {
    ...
    enum displayField: Int, CaseIterable {
        ...
        func tite() -> String {
            switch self {
            case .email:
                return NSLocalizedString("Email", comment: "Email detail cell title")
            case .color:
                return NSLocalizedString("Favourite colour", comment: "Favourite colour detail cell title")
            case .joined:
                return NSLocalizedString("Joined", comment: "Joined detail cell title")
            }
        }
